...
Validate the data (for documentation, see the section `Extracting and validating input data` below):
...
Enrich the data (see the section `Enriching the data` below)
