...
#### 4. Flag outliers of the raw data
...
#### 5. Calculate time_since_previous_fix
...
#### 8. Calculate distance to colony
...
#### 9. Flag outliers derived values

If a derived/calculated record:

* has a `calc_speed_2d` higher than 33.333 m/s (~120km/h) or below 0.

it is flagged as outlier. This means that the existing `outlier` field is set to `TRUE`.

#### 10. Link with Corine land use
